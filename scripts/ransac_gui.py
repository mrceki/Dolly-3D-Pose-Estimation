...
class RANSAC_subscriber():
    def __init__(self):
        ...
        self.residual_threshold = 0.044
        self.max_fails = 2
        self.max_cluster_dist = 0.029
        self.stop_n_inliers = 6
    def RANSAC(self, msg):
        variables = [
       "max_range",
       "min_range",
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.min_samples_slider.setRange(0, 100)
        self.residual_threshold_slider.setRange(0, 5000)
        self.max_fails_slider.setRange(0, 1000)
        self.max_cluster_dist_slider.setRange(0, 100)
    ...
    def update_max_range(self, value):
        self.ransac.max_range = value / 100.0
    ...
    def update_residual_threshold(self, value):
        self.ransac.residual_threshold = value / 10000.0
